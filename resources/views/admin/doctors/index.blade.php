            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('admin.doctors.index') }}" class="text-muted text-hover-primary">الاطباء
                                المضافون</a>
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{ route('admin.doctors.create') }}" class="btn btn-sm fw-bold btn-primary">طبيب جديد</a>
                    {{-- <a href="{{ route('admin.doctors.trash') }}" class="btn btn-sm fw-bold btn-danger">سلة المهملات</a> --}}
                    <!--end::Primary button-->
                </div>
                <!--end::Actions-->
            </div>
                                    ...
                                    <tbody>
                                        @foreach ($doctors as $doctor)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $doctor->extra }}</td>
                                                <td><img src="{{ url('doctor_photo/'.$doctor->photo) }}" style="width: 50px; height: 50px; object-fit: cover;"></td>                                                <td>{{ $doctor->created_at }}</td>
                                                ...
                                                <td>
                                                    @if (!$doctor->trashed())
                                                        <a class="btn btn-info"
                                                            href="{{ route('admin.doctors.edit', $doctor->id) }}">تعديل</a>
                                                    @else
                                                        <form method="post"
                                                            action="{{ route('admin.doctors.forceDelete', $doctor->id) }}">
                                                            @csrf
                                                            @method('HEAD')
                                                            <input type="submit"
                                                                class="btn btn-xs btn-danger btn-flat show_confirm"
                                                                href="{{ route('admin.doctors.forceDelete', $doctor->id) }}"
                                                                value="حذف نهائي">
                                                        </form>
                                                    @endif
                                                ...
                                                <td>
                                                    @if ($doctor->trashed())
                                                        <a href="{{ route('admin.doctors.restore', $doctor->id) }}"
