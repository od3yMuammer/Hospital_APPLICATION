            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('admin.articles.index') }}" class="text-muted text-hover-primary">المقالات
                                المضافة</a>
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{ route('admin.articles.create') }}" class="btn btn-sm fw-bold btn-primary">مقالة جديدة</a>
                    {{-- <a href="{{ route('admin.articles.trash') }}" class="btn btn-sm fw-bold btn-danger">سلة المهملات</a> --}}
                    <!--end::Primary button-->
                </div>
                <!--end::Actions-->
            </div>
                                    ...
                                    <tbody>
                                        @foreach ($articles as $article)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $article->categore->name }}</td>
                                                <td><img src="{{ url('article_images/'.$article->image) }}" style="width: 50px; height: 50px; object-fit: cover;"></td>                                                <td>{{ $article->created_at }}</td>
                                                <td>
                                                ...
                                                <td>
                                                    @if (!$article->trashed())
                                                        <a class="btn btn-info"
                                                            href="{{ route('admin.articles.edit', $article->id) }}">تعديل</a>
                                                    @else
                                                        <form method="post"
                                                            ...
                                                            <input type="submit"
                                                                ...
                                                                href="{{ route('admin.articles.forceDelete', $article->id) }}"
                                                                value="حذف نهائي">
                                                        </form>
                                                    @endif
